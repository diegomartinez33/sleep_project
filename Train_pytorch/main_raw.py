...
someList = ['dataBaseDict_ST_raw_10_3.pkl', 'dataBaseDict_ST_raw_10_0.pkl', 'dataBaseDict_SC_raw_10_0.pkl', 'dataBaseDict_SC_raw_30_0.pkl']
        ...
        if file.endswith(".pkl") and file not in someList:
            ...
            for i in range(1,4):
                ...
                try:
                    ...
                    testMetrics(loaders[2], model, args, criterion, saveFolder=saveComb, trainFold=i)
