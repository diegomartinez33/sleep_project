...
ACCpath = osp.join(TesisPath, 'results/kernel_exps/trainResults_raw', kernel_shape)
modelsPath = osp.join(TesisPath, 'results/kernel_exps/trainModels_raw', kernel_shape)
...
from square_480x9_net import Net_raw
