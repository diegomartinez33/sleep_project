...
ACCpath = osp.join(TesisPath, 'results/block_exps/trainResults', num_blocks)
modelsPath = osp.join(TesisPath, 'results/block_exps/trainModels', num_blocks)
...
netsfolder = osp.join(codesTrainfolder, 'nets', 'blocks_exp')
...
from net_2_blocks import Net_30s
from net_2_blocks import Net_10s
...
# Functions
# --------------------------------------------------------------------------------------------------------------
someList = ['dataBaseDict_SC_amp_10_0.pkl', 'dataBaseDict_SC_amp_30_0.pkl',
            'dataBaseDict_SC_amp_10_3.pkl', 'dataBaseDict_SC_amp_30_3.pkl']
