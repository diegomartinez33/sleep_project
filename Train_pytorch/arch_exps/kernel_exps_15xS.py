...
ACCpath = osp.join(TesisPath, 'results/kernel_exps/trainResults', kernel_shape)
modelsPath = osp.join(TesisPath, 'results/kernel_exps/trainModels', kernel_shape)
...
from square_15xS_net import Net_30s
from square_15xS_net import Net_10s
from square_15xS_net import Net_30s_ST
from square_15xS_net import Net_10s_ST
...
# Functions
# --------------------------------------------------------------------------------------------------------------
someList = ['dataBaseDict_ST_amp_10_3.pkl', 'dataBaseDict_ST_amp_10_0.pkl', 'dataBaseDict_ST_amp_30_0.pkl']
...
def train_kernel_exp(balancedPath=data_base_path,Ei=1):
    ...
    for file in os.listdir(balancedPath):
        if file.endswith(".pkl") and file not in someList:
            print(file)
