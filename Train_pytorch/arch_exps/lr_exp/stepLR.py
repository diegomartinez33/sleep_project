...
ACCpath = osp.join(TesisPath, 'results/lr_exps/trainResults', epochs_change)
modelsPath = osp.join(TesisPath, 'results/lr_exps/trainModels', epochs_change)
...
def adjust_learning_rate(optimizer, epoch):
    ...
    lr = args.lr * (0.1 ** (epoch // int(epochs_change)))
    for param_group in optimizer.param_groups:
        param_group['lr'] = lr
