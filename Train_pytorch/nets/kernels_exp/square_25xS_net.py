...
class Net_30s(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 128, kernel_size=(25, 3), padding=(12, 0))
        ...
        self.conv2 = nn.Conv2d(1, 128, kernel_size=(25, 128), padding=(12, 0))
        ...
        self.conv3 = nn.Conv2d(1, 128, kernel_size=(25, 128), padding=(12, 0))
...
class Net_30s_ST(nn.Module):
    def __init__(self):
        ...
        # first convolutional block
        self.conv1 = nn.Conv2d(1, 128, kernel_size=(25, 4), padding=(12, 0))
        # asymmetric kernel:  self.conv1 = nn.Conv2d(1, 128, kernel_size=(23,3), padding=11)
        self.bn1 = nn.BatchNorm2d(128)
        self.relu1 = nn.ReLU()
        # first pooling
