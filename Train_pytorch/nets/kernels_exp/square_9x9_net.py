...
class Net_raw(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 128, kernel_size=(9, 9), padding=(4, 4))
        ...
        self.conv2 = nn.Conv2d(128, 128, kernel_size=(9, 9), padding=(4, 4))
        ...
        self.conv3 = nn.Conv2d(128, 128, kernel_size=(9, 9), padding=(4, 4))
