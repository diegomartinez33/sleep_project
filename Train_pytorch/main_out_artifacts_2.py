...
ACCpath = osp.join(TesisPath, 'results/trainResults_out_artif')
modelsPath = osp.join(TesisPath, 'results/trainModels_out_artif')

data_base_path = osp.join(TesisPath, 'Data', 'DOE_databases', 'balancedData')
data_base_file = 'dataBaseDict_SC_amp_10_3.pkl'
